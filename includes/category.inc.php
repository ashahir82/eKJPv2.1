...
<div class="section">
	<div class="container">
		<div class="row">
			<h2 class="text-center">Daftar Kategori Program</h2>
			<hr class="half-rule">
		</div>
		<div id="result"></div>
		...
		<div class="row">
			<div class="col-md-12">
				<a data-toggle="modal" href="#courseDetail" data-id="add" id="regCat" class="btn btn-success" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah</a>
		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header bg-primary">
								...
								<h3 class="modal-title text-center">Daftar Kategori Program</h3>
							</div>
							<div class="modal-body">
								...
								<form action="" method="post" class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="name" placeholder="Nama Kategori Program" name="name">
										</div>
									</div>
								</form>
							</div>
							<div class="modal-footer bg-primary">
								<button type="button" class="btn btn-success" id="saveCat"><span class="glyphicon glyphicon-save" aria-hidden="true"></span> Simpan</button>
				...
				<script language="javascript" type="text/javascript">loadAllCat();</script>
			</div>
		</div>
		<hr class="half-rule">
	</div>
