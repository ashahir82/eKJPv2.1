	...
	<div class="container">
		...
		<form action="" method="post" class="form-horizontal applyForm">
			...
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#admin" aria-controls="data" role="tab" data-toggle="tab">Pentadbir</a></li>
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="admin">
					<h4 class="text-center text-primary">PENTADBIR</h4>
					<div class="form-group">
						<label for="username" class="col-sm-2 control-label">Username <span class="text-danger">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="username" placeholder="Username" name="username" value="<?php echo $cfg_username; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="pass" class="col-sm-2 control-label">Katalaluan <span class="text-danger">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="pass" placeholder="Katalaluan" name="pass" value="<?php echo $cfg_pass; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="fullname" class="col-sm-2 control-label">Nama Penuh</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="fullname" placeholder="Nama Penuh" name="fullname" value="<?php echo $cfg_fullname; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="notel" class="col-sm-2 control-label">No. Tel <span class="text-danger">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="notel" placeholder="No. Tel" name="notel" value="<?php echo $cfg_notel; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="email_admin" class="col-sm-2 control-label">Alamat E-Mel <span class="text-danger">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="email_admin" placeholder="Alamat E-Mel" name="email_admin" value="<?php echo $cfg_email_admin; ?>">
						</div>
					</div>
				</div>
