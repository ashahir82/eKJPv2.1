<div class="section">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button type="button" class="btn btn-success" id="certSave"><span class="glyphicon glyphicon-save" aria-hidden="true"></span> Simpan</button>
								<a href="index.php?p=cert" class="btn btn-warning" role="button"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Batal</a>
							</div>
						</div>
	...
	<script language="javascript" type="text/javascript">loadCert(<?php echo $_GET['cid']; ?>);</script>
	<?php } else { ?>
